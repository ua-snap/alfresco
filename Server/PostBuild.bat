...
start "Editing FRESCO Binary" /D"C:\Program Files\Microsoft Visual Studio 8\VC\bin\" /WAIT editbin.exe "P:\Fresco\trunk\Server\bin\Release\FRESCO Server.exe" /LARGEADDRESSAWARE"
