...
namespace Uaf.Controls
{
    public class UafListView : ListView
    {
        ...
        protected override void OnDragDrop(DragEventArgs e)
        {
            ...
            foreach (ListViewItem item in base.SelectedItems)
            {
                ...
                //string newKey = ((ListViewItem)insertItems[insertItems.Count - 1]).Name;
                //string oldKey = item.Name;
                //newKey = oldKey;
                //oldKey += ".old";
                //item.Name = oldKey;
                //((ListViewItem)insertItems[insertItems.Count - 1]).Name = newKey;
            }
