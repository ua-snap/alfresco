...
public:
    BarrenLichenMoss(const int& rAge=0,
          ...
          const Species& rSpeciesSubCanopy=gBarrenLichenMossID);
    BarrenLichenMoss(const Frame& rFrame);
    ~BarrenLichenMoss() {}
    static void				clear();
