...
void CustomLandscape::      collectStats()
{
    ...
    //}
    ////E2
    //if (pCurFrame->type() == 2 || pCurFrame->type() == 3) 
    //{
    //    if (pCurFrame->age() > 80) 
    //    {
    //        count++;
    ...
    //for each cell
    //  for each criteria
    //    if (evaluate(cirteria[c])) cirteria++;
    //
    //for each criteria
    //  criteria.saveToStat()
    //unsigned int count = 0;
    //for (int cell=0; cell<4000000; cell++) {
    //    for (int crit=0; crit<30; crit++) {
    //        if ((cell % 10)*crit < 14)
    //            count++;
    //        if ((cell/10)*crit < 352)
    //            count++;
    //        if (((cell/10)*crit > 1000) || ((cell/10)*crit < 352))
    //            count++;
    //    }
    //}
