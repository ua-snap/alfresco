...
start "Adding 3GB Flag to EXE Header" /D"C:\Program Files\Microsoft Visual Studio 8\VC\bin\" /WAIT editbin.exe "P:\Fresco\trunk\Client\Release\Client.exe" /LARGEADDRESSAWARE
